    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white">
            <div className="font-[sans-serif]">
                <div className="min-h-[160px] bg-gradient-to-r from-blue-800 to-blue-400 p-4 text-center sm:p-6">
                ...
                <div className="mx-4 -mt-16 mb-4">
                    <form className="mx-auto max-w-4xl rounded-md bg-white p-4 shadow-[0_2px_13px_-6px_rgba(0,0,0,0.4)] sm:p-8">
                        <div className="grid gap-8 md:grid-cols-2">
                            <button
                                ...
                                <svg
                                    ...
                                    width="22px"
                                    fill="#fff"
                                    className="mr-4 inline shrink-0"
                                    viewBox="0 0 512 512">
                                    <path
                                        fill="#fbbd00"
                            ...
                            <button
                                type="button"
                                className="flex w-full items-center justify-center rounded-md border-none bg-black px-6 py-3 text-sm font-semibold tracking-wider text-white outline-none hover:bg-[#333]">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="22px"
                                    fill="#fff"
                        ...
                        <div className="grid gap-8 md:grid-cols-2">
                            <div>
                                ...
                                <input
                                    name="name"
                                    type="text"
                                    className="w-full rounded-md bg-gray-100 px-4 py-3 text-sm text-gray-800 outline-blue-500 transition-all focus:bg-transparent"
                        ...
                        <div className="mt-8">
                            <button
                                type="button"
                                className="rounded-md bg-blue-500 px-6 py-3 text-sm font-semibold tracking-wider text-white hover:bg-blue-600 focus:outline-none">
                                Sign up
                            </button>
                        </div>
                    </form>
